...
describe('template spec', () => {
    ...
    it('EP11-CREAR-TAG', async () => {
        ...
        await cy.screenshot('G3/EP11_2_dashboard', { 'overwrite': true });
        await Tags.gotoTagsPageV3();
        await cy.screenshot('G3/EP11_3_tags', { 'overwrite': true });
        await Tags.gotoNewtagPageV3();
        await cy.screenshot('G3/EP11_3_new_tag', { 'overwrite': true });
    ...
    it('EP14-ELIMINAR-TAG', async () => {
        ...
        Login.setLoginEmail();
        Login.setLoginPassword();
        await cy.screenshot('G3/EP14_1_login', { 'overwrite': true });
        await Login.submitLogin(3);
        await cy.screenshot('G5/EP14_2_dashboard', { 'overwrite': true });
        await Tags.gotoTagsPageV3();
        await cy.screenshot('G3/EP14_3_tags', { 'overwrite': true });
        await Tags.findTagV3(tagName);
        await cy.screenshot('G3/EP14_4_delete_tag', { 'overwrite': true });
        await Tags.deleteTagV3();
        await cy.screenshot('G3/EP14_5_dashboard', { 'overwrite': true });
