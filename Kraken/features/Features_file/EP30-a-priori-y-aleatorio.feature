...
@user18 @web
Scenario: EP30 - Crear un miembro con el nombre con codigo HTML
    ...
    And I wait for 5 seconds
    And I enter the name of the member "<MEMBER_NAME_HTML>"
    And I wait for 2 seconds
    ...
    And I wait for 5 seconds
    And I verify the member was created with "<MEMBER_NAME_HTML>"
